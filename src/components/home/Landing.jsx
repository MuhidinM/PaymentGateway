  ...
  return (
    <>
      <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto mt-32 max-w-screen-xl text-center lg:px-12">
          <a
            href="/"
      ...
      <section class="bg-white px-36 dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto sm:py-16 lg:px-6">
          <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary lg:h-12 lg:w-12 dark:bg-primary">
                <svg
                  class="w-5 h-5 text-base-100 lg:w-6 lg:h-6 dark:text-primary"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                >
      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
          ...
          <div class="mt-4 md:mt-0">
            ...
            <a
              href="/registration"
              class="inline-flex items-center text-white bg-primary hover:bg-primary focus:ring-4 focus:ring-primary font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary"
            >
              Get started
              <svg
                class="ml-2 -mr-1 w-5 h-5"
